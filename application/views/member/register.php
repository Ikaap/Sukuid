    ...
    <div class="login-page">
        <div class="container">
            <form action="<?php echo site_url('main/save_register');?>" method="POST" autocomplete="off">
                ...
                <h6>Silakan Register terlebih dahulu</h6>
                <br>
                <div class="col-sm-12">
                ...
                <div class="col-sm-12">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="Username" name="nama" placeholder="Nama"  required>
                ...
                <div class="col-sm-12">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="Username" name="nohp" placeholder="Nomor Telepon"  required>
                        <label for="floatingInput">Nomor Telepon</label>
                    </div>
                </div>
                <br>
                <button class="btn btn-outline-primary">Daftar</button><br><br>
            </form>
        </div>
    </div>
